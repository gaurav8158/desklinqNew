  ...
  return (
    <div className="listingSection__wrap">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 text-sm text-neutral-700 dark:text-neutral-300">
        ...
        <button
          className="text-[#6115E7] flex gap-2 border-b border-[#6115E7] w-20 items-center space-x-3 "
          onClick={openOfferingModalAmenities}
        >
      ...
      {/* <button className="text-[#6115E7] " onClick={openOfferingModalAmenities}>
        View all
      </button> */}
      {renderAmenities()}
    </div>
