      ...
      <Listbox value={selected} onChange={setSelected}>
        {({ open }) => (
          <div className="relative mt-1">
            <Listbox.Button className="relative w-full rounded-lg focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white h-10 cursor-pointer dark:border-neutral-700 dark:focus:ring-primary-6000 dark:focus:ring-opacity-25 dark:bg-neutral-900 ">
