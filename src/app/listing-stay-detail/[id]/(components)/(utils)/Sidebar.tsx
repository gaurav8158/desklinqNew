  ...
  return (
    <div className="listingSectionSidebar__wrap shadow-xl">
      ...
      <form className="flex flex-col border border-neutral-200 dark:border-neutral-700 rounded-3xl ">
        ...
        <div className="p-2 text-neutral-6000 dark:text-neutral-300">
          <PricingSelection
          ...
          offering.type == 'MEETING_ROOMS' ? (
            ...
            <div className="my-2 flex gap-4 md:gap-0 text-center items-center justify-center ">
      ...
      >
        {offering?.AvailabilityStatus === 'Booked' ? 'Sold out' : 'Book now'}
      </ButtonPrimary>
    </div>
  )
}
