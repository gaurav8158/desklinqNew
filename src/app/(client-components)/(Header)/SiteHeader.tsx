...
import Notification from '@/components/Tostify/Notification'
...
const PAGES_HIDE_HEADER_BORDER: PathName[] = [
  ...
  '/listing-experiences-detail' as Route,
]
...
const SiteHeader = () => {
  ...
  let [homePages] = useState<HomePageItem[]>([
    { name: 'Home Main', slug: '/' as Route },
    { name: 'Real Estate', slug: '/home-2' as Route },
    { name: 'Home 3', slug: '/home-3' as Route },
  ])
  ...
  return (
    <>
      ...
      {renderHeader()}
      <Notification style={{ padding: '15px' }} limit={1} />
