...
import { AddressType, OfferingType } from '@/type/propertiesTypes'
...
const ListingCard: FC<any> = ({ className, data }) => {
  const { offering, name, address, price, href, galleryImgs } = data
  ...
  const renderSliderGallery = () => {
    return (
      <div className="relative w-full">
        <GallerySlider
          uniqueID={`ListingCard_${offering.id}`}
        ...
        <Badge name="Trending" color="red" className="absolute left-3 top-3" />
      </div>
    )
  }
